...
Public Class CaptchaControl
    ...
    Private _text As String = "" '"کد داخل تصویر را وارد کنید :"
    ...
    Private _CaptchaLangs As String
...
#Region "  Public Properties"
    ...
    <DefaultValue("fa-IR"), _
    Description("Language of error message."), _
    Category("Captcha")> _
    Public Property CaptchaLangs() As String
        Get
            Return _CaptchaLangs
        End Get
        Set(ByVal Value As String)
            _CaptchaLangs = Value
        End Set
...
#End Region
    ...
    Private Sub ValidateCaptcha(ByVal userEntry As String)
        ...
        If ci Is Nothing Then
            Select Case _CaptchaLangs
                Case "fa-IR"
                    Me.ErrorMessage = "کد امنیتی پس از " & Me.CaptchaMaxTimeout & " ثانیه منقضی می شود."
                Case "en-US"
        ...
        If Me.CaptchaMinTimeout > 0 Then
            If (ci.RenderedAt.AddSeconds(Me.CaptchaMinTimeout) > Now) Then
                ...
                Select Case _CaptchaLangs
                    Case "fa-IR"
                        Me.ErrorMessage = "سرعت ورود چندین کد امنیتی بیش از حد مجاز است. لطفا " & Me.CaptchaMinTimeout & " ثانیه صبر کنید."
                    Case "en-US"
        ...
        If String.Compare(userEntry, ci.Text, True) <> 0 Then
            Select Case _CaptchaLangs
                Case "fa-IR"
                    Me.ErrorMessage = "کد امنیتی وارد شده صحیح نیست."
                Case "en-US"
