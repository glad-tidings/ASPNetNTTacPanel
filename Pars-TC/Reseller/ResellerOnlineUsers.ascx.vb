Public Class ResellerOnlineUsers
    ...
    Private Sub OnlineUser()
        ...
        MainOU.InnerHtml = "<h2>پنل فروشندگان</h2>" + _
        ...
        Try
            ...
            Try
                ...
                Do While d.Read
                    If d("Username".ToString).ToString.ToLower <> "admin" And Left(d("Username".ToString).ToString.ToLower, 4) = TMP.Item(1) Then
