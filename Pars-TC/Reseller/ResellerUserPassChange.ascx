<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ResellerUserPassChange.ascx.vb" Inherits="Pars_TC.ResellerUserPassChange" %>

<h2>کنترل پنل فروشندگان</h2>
<div class='featured'><h3>تغییر کلمه عبور کاربر</h3>
...
<table><tr><td class="Tdlbl">نام کاربری : </td><td><input dir="ltr" id="cpusername" type="text" readonly runat="server" class="login" /></td></tr>
